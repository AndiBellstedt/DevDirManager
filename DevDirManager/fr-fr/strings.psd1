...
@{
    ...
    'GetDevDirectorySetting.Message.ConfigNotFound'            = "Fichier de configuration non trouvé à : {0}"
    'GetDevDirectorySetting.Message.ConfigLoaded'              = "Configuration chargée avec succès depuis : {0}"
    'GetDevDirectorySetting.Message.SettingNotFound'           = "Paramètre '{0}' non trouvé dans la configuration."
    'GetDevDirectorySetting.Message.SettingValue'              = "Paramètre '{0}' a la valeur : {1}"
    #endregion Get-DevDirectorySetting

    #region Set-DevDirectorySetting
    'SetDevDirectorySetting.Message.SettingChanged'            = "Paramètre '{0}' modifié de '{1}' à '{2}'."
    'SetDevDirectorySetting.Message.ConfigSaved'               = "Configuration enregistrée dans : {0}"
    'SetDevDirectorySetting.Message.CreatingNewConfig'         = "Création d'un nouveau fichier de configuration à : {0}"
    'SetDevDirectorySetting.Message.PathInvalid'               = "Le chemin spécifié n'existe pas : {0}"
    'SetDevDirectorySetting.ShouldProcess.Target'              = "Configuration système"
    ...
    'InvokeDevDirectorySync.Message.Started'                   = "Démarrage de la synchronisation DevDirectory."
    'InvokeDevDirectorySync.Message.NoPathConfigured'          = "Aucun RepositoryListPath configuré. Utilisez Set-DevDirectorySetting pour configurer."
    'InvokeDevDirectorySync.Message.NoTargetConfigured'        = "Aucun DefaultTargetPath configuré. Utilisez Set-DevDirectorySetting pour configurer."
    'InvokeDevDirectorySync.Message.PathNotFound'              = "Fichier de liste de référentiels non trouvé : {0}"
    'InvokeDevDirectorySync.Message.FilterApplied'             = "Application du filtre système '{0}' aux référentiels."
    'InvokeDevDirectorySync.Message.FilteredCount'             = "{0} sur {1} référentiels correspondent au filtre système."
    'InvokeDevDirectorySync.Message.Completed'                 = "Synchronisation DevDirectory terminée. {0} référentiels traités."
    'InvokeDevDirectorySync.Message.Failed'                    = "Échec de la synchronisation DevDirectory : {0}"
    #endregion Invoke-DevDirectorySync

    #region Register-DevDirectoryScheduledSync
    'RegisterDevDirectoryScheduledSync.Message.Created'        = "Tâche planifiée '{0}' créée avec succès."
    'RegisterDevDirectoryScheduledSync.Message.Updated'        = "Tâche planifiée '{0}' mise à jour avec succès."
    'RegisterDevDirectoryScheduledSync.Message.Failed'         = "Échec de la création de la tâche planifiée : {0}"
    'RegisterDevDirectoryScheduledSync.Message.NoConfig'       = "Aucune configuration système trouvée. Exécutez d'abord Set-DevDirectorySetting."
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Target'   = "Planificateur de tâches Windows"
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Action'   = "Créer la tâche planifiée '{0}' avec un intervalle de {1} minutes"
    #endregion Register-DevDirectoryScheduledSync

    #region Unregister-DevDirectoryScheduledSync
    'UnregisterDevDirectoryScheduledSync.Message.Removed'      = "Tâche planifiée '{0}' supprimée avec succès."
    'UnregisterDevDirectoryScheduledSync.Message.NotFound'     = "Tâche planifiée '{0}' non trouvée."
    'UnregisterDevDirectoryScheduledSync.Message.Failed'       = "Échec de la suppression de la tâche planifiée : {0}"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Target' = "Planificateur de tâches Windows"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Action' = "Supprimer la tâche planifiée '{0}'"
