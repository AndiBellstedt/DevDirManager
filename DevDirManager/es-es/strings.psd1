...
@{
    ...
    'ImportDevDirectoryList.StatusDateParseError'           = "No se puede analizar StatusDate '{0}' como DateTime: {1}"
    ...
    'ExportDevDirectoryList.InferFormatFailed'              = "No se puede inferir el formato de exportación de la ruta '{0}'. Especifique el parámetro Format."
    ...
    'RestoreDevDirectory.CloningRepository'                 = "Clonando repositorio {0}/{1}: {2} -> {3}"
