...
@{
    ...
    'GetDevDirectorySetting.Message.ConfigNotFound'            = "Archivo de configuración no encontrado en: {0}"
    'GetDevDirectorySetting.Message.ConfigLoaded'              = "Configuración cargada exitosamente desde: {0}"
    'GetDevDirectorySetting.Message.SettingNotFound'           = "Configuración '{0}' no encontrada en la configuración."
    'GetDevDirectorySetting.Message.SettingValue'              = "Configuración '{0}' tiene el valor: {1}"
    #endregion Get-DevDirectorySetting

    #region Set-DevDirectorySetting
    'SetDevDirectorySetting.Message.SettingChanged'            = "Configuración '{0}' cambiada de '{1}' a '{2}'."
    'SetDevDirectorySetting.Message.ConfigSaved'               = "Configuración guardada en: {0}"
    'SetDevDirectorySetting.Message.CreatingNewConfig'         = "Creando nuevo archivo de configuración en: {0}"
    'SetDevDirectorySetting.Message.PathInvalid'               = "La ruta especificada no existe: {0}"
    'SetDevDirectorySetting.ShouldProcess.Target'              = "Configuración del sistema"
    ...
    'InvokeDevDirectorySync.Message.Started'                   = "Iniciando sincronización de DevDirectory."
    'InvokeDevDirectorySync.Message.NoPathConfigured'          = "No hay RepositoryListPath configurado. Use Set-DevDirectorySetting para configurar."
    'InvokeDevDirectorySync.Message.NoTargetConfigured'        = "No hay DefaultTargetPath configurado. Use Set-DevDirectorySetting para configurar."
    'InvokeDevDirectorySync.Message.PathNotFound'              = "Archivo de lista de repositorios no encontrado: {0}"
    'InvokeDevDirectorySync.Message.FilterApplied'             = "Aplicando filtro de sistema '{0}' a los repositorios."
    'InvokeDevDirectorySync.Message.FilteredCount'             = "{0} de {1} repositorios coinciden con el filtro del sistema."
    'InvokeDevDirectorySync.Message.Completed'                 = "Sincronización de DevDirectory completada. {0} repositorios procesados."
    'InvokeDevDirectorySync.Message.Failed'                    = "Error en la sincronización de DevDirectory: {0}"
    #endregion Invoke-DevDirectorySync

    #region Register-DevDirectoryScheduledSync
    'RegisterDevDirectoryScheduledSync.Message.Created'        = "Tarea programada '{0}' creada exitosamente."
    'RegisterDevDirectoryScheduledSync.Message.Updated'        = "Tarea programada '{0}' actualizada exitosamente."
    'RegisterDevDirectoryScheduledSync.Message.Failed'         = "Error al crear la tarea programada: {0}"
    'RegisterDevDirectoryScheduledSync.Message.NoConfig'       = "No se encontró configuración del sistema. Ejecute primero Set-DevDirectorySetting."
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Target'   = "Programador de tareas de Windows"
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Action'   = "Crear tarea programada '{0}' con intervalo de {1} minutos"
    #endregion Register-DevDirectoryScheduledSync

    #region Unregister-DevDirectoryScheduledSync
    'UnregisterDevDirectoryScheduledSync.Message.Removed'      = "Tarea programada '{0}' eliminada exitosamente."
    'UnregisterDevDirectoryScheduledSync.Message.NotFound'     = "Tarea programada '{0}' no encontrada."
    'UnregisterDevDirectoryScheduledSync.Message.Failed'       = "Error al eliminar la tarea programada: {0}"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Target' = "Programador de tareas de Windows"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Action' = "Eliminar tarea programada '{0}'"
