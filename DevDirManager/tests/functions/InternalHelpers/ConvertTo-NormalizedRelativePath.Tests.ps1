Describe "ConvertTo-NormalizedRelativePath" -Tag "InternalFunction", "Path" {
    ...
    InModuleScope 'DevDirManager' {
        ...
        Context "Parameter Contract" {
            ...
            BeforeAll {
                $command = Get-Command -Name 'ConvertTo-NormalizedRelativePath' -ErrorAction Stop
            ...
            It "Should have the correct attributes" {
                $parameters['Path'].Attributes.TypeId.Name | Should -Contain 'AllowEmptyStringAttribute'
            }
