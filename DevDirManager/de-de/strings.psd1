...
@{
    ...
    #region Get-DevDirectorySetting
    'GetDevDirectorySetting.Message.ConfigNotFound'            = "Konfigurationsdatei nicht gefunden unter: {0}"
    'GetDevDirectorySetting.Message.ConfigLoaded'              = "Konfiguration erfolgreich geladen von: {0}"
    'GetDevDirectorySetting.Message.SettingNotFound'           = "Einstellung '{0}' nicht in der Konfiguration gefunden."
    'GetDevDirectorySetting.Message.SettingValue'              = "Einstellung '{0}' hat den Wert: {1}"
    #endregion Get-DevDirectorySetting

    #region Set-DevDirectorySetting
    'SetDevDirectorySetting.Message.SettingChanged'            = "Einstellung '{0}' geändert von '{1}' zu '{2}'."
    'SetDevDirectorySetting.Message.ConfigSaved'               = "Konfiguration gespeichert nach: {0}"
    'SetDevDirectorySetting.Message.CreatingNewConfig'         = "Erstelle neue Konfigurationsdatei unter: {0}"
    'SetDevDirectorySetting.Message.PathInvalid'               = "Der angegebene Pfad existiert nicht: {0}"
    'SetDevDirectorySetting.ShouldProcess.Target'              = "System-Konfiguration"
    'SetDevDirectorySetting.ShouldProcess.Action'              = "Einstellung '{0}' auf '{1}' setzen"
    #endregion Set-DevDirectorySetting

    #region Invoke-DevDirectorySync
    'InvokeDevDirectorySync.Message.Started'                   = "DevDirectory-Synchronisierung wird gestartet."
    'InvokeDevDirectorySync.Message.NoPathConfigured'          = "Kein RepositoryListPath in der Konfiguration festgelegt. Verwenden Sie Set-DevDirectorySetting zur Konfiguration."
    'InvokeDevDirectorySync.Message.NoTargetConfigured'        = "Kein DefaultTargetPath in der Konfiguration festgelegt. Verwenden Sie Set-DevDirectorySetting zur Konfiguration."
    'InvokeDevDirectorySync.Message.PathNotFound'              = "Repository-Listendatei nicht gefunden: {0}"
    'InvokeDevDirectorySync.Message.FilterApplied'             = "Systemfilter '{0}' wird auf Repositories angewendet."
    'InvokeDevDirectorySync.Message.FilteredCount'             = "{0} von {1} Repositories entsprechen dem Systemfilter."
    'InvokeDevDirectorySync.Message.Completed'                 = "DevDirectory-Synchronisierung abgeschlossen. {0} Repositories verarbeitet."
    'InvokeDevDirectorySync.Message.Failed'                    = "DevDirectory-Synchronisierung fehlgeschlagen: {0}"
    #endregion Invoke-DevDirectorySync

    #region Register-DevDirectoryScheduledSync
    'RegisterDevDirectoryScheduledSync.Message.Created'        = "Geplante Aufgabe '{0}' erfolgreich erstellt."
    'RegisterDevDirectoryScheduledSync.Message.Updated'        = "Geplante Aufgabe '{0}' erfolgreich aktualisiert."
    'RegisterDevDirectoryScheduledSync.Message.Failed'         = "Erstellen der geplanten Aufgabe fehlgeschlagen: {0}"
    'RegisterDevDirectoryScheduledSync.Message.NoConfig'       = "Keine System-Konfiguration gefunden. Führen Sie zuerst Set-DevDirectorySetting aus."
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Target'   = "Windows Aufgabenplanung"
    'RegisterDevDirectoryScheduledSync.ShouldProcess.Action'   = "Geplante Aufgabe '{0}' mit {1}-Minuten-Intervall erstellen"
    #endregion Register-DevDirectoryScheduledSync

    #region Unregister-DevDirectoryScheduledSync
    'UnregisterDevDirectoryScheduledSync.Message.Removed'      = "Geplante Aufgabe '{0}' erfolgreich entfernt."
    'UnregisterDevDirectoryScheduledSync.Message.NotFound'     = "Geplante Aufgabe '{0}' nicht gefunden."
    'UnregisterDevDirectoryScheduledSync.Message.Failed'       = "Entfernen der geplanten Aufgabe fehlgeschlagen: {0}"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Target' = "Windows Aufgabenplanung"
    'UnregisterDevDirectoryScheduledSync.ShouldProcess.Action' = "Geplante Aufgabe '{0}' entfernen"
    #endregion Unregister-DevDirectoryScheduledSync
}
