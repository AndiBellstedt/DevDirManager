...
@{
    ...
    'ImportDevDirectoryList.StatusDateParseError'           = "Unable to parse StatusDate '{0}' as DateTime: {1}"
    ...
    'RestoreDevDirectory.CloningRepository'                 = "Cloning repository {0}/{1}: {2} -> {3}"
    ...
    'TestDevDirectoryRemoteAccessible.EmptyUrl'             = "Remote URL is empty, marking as inaccessible"
